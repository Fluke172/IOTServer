...
import com.cssf.pojo.disused.TestBean;
 ...
 * @since: 2021/8/18
 */
public class ServerEncoder implements Encoder.Text<TestBean> {
     ...
     */
    @Override
    public String encode(TestBean hashMap) throws EncodeException {
        /*
